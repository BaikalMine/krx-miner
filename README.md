...
```text
https://github.com/BaikalMine/krx-miner/releases/download/v0.1.2/keryx-miner-v0.1.2-OPoI-hiveos.tar.gz
```
  ...
  "items": [
    {
      ...
      "miner_config": {
        ...
        "install_url": "https://github.com/BaikalMine/krx-miner/releases/download/v0.1.2/keryx-miner-v0.1.2-OPoI-hiveos.tar.gz",
